...
const posts: Testimonial[] = [
  { handle: "@jpriyajain31", name: "Priya jain", avatar: g1, photo: g3, city: "Noida Sector-62", workshop: "Canvas Sundays", bio: "Product designer chasing softer weekends.", interests: ["Art", "Coffee", "Books"], quote: "Painted for the first time in years. Left with a canvas and three new friends.", likes: 482, comments: 34 },
  { handle: "@jain_anshii", name: "Anshika Jain", avatar: g6, photo: g6, city: "Delhi", workshop: "Acoustic Night", bio: "Backend by day, bad guitar by night.", interests: ["Music", "Coffee", "Travel"], quote: "The most beautiful little community gig I've been to.", likes: 611, comments: 52 },
  { handle: "@triptigargmakeup", name: "Tripti Garg", avatar: g4, photo: g4, city: "Delhi", workshop: "Candle Making", bio: "Making things with my hands + oat lattes.", interests: ["DIY", "Wellness", "Home"], quote: "Every candle in my apartment is now mine. Obsessed.", likes: 728, comments: 41 },
  { handle: "@_outandaboutevents", name: "Out&About", avatar: g5, photo: g5, city: "Connaught Place", workshop: "Book Club", bio: "Reader. Writer. Pretend photographer.", interests: ["Books", "Poetry", "Cinema"], quote: "Found my new favourite Sunday ritual.", likes: 394, comments: 28 },
  { handle: "@aarav.s", name: "Aarav Shah", avatar: g9, photo: g9, city: "Delhi", workshop: "Boozy Brunch", bio: "Consultant. Foodie. Occasional runner.", interests: ["Food", "Travel", "Wine"], quote: "Bottomless mimosas + strangers-to-friends energy.", likes: 512, comments: 47 },
  { handle: "@_neha2904_", name: "Neha", avatar: g8, photo: g8, city: "Preet Vihar", workshop: "Sunrise Yoga", bio: "Slow mornings, softer minds.", interests: ["Yoga", "Ocean", "Journaling"], quote: "Started my Sunday on a mat and left glowing.", likes: 856, comments: 63 },
  { handle: "@parulatul_jain", name: "Parul Jain", avatar: g2, photo: g2, city: "Delhi", workshop: "Pottery", bio: "Clay, chai, repeat.", interests: ["Ceramics", "Chai", "Design"], quote: "Two hours on the wheel felt like meditation.", likes: 289, comments: 19 },
  { handle: "@jinishaajain", name: "Jinishaa jain", avatar: g7, photo: g7, city: "Preet Vihar", workshop: "Picnic Social", bio: "Golden-hour chaser.", interests: ["Nature", "Music", "People"], quote: "Sunset, strangers, sandwiches. Perfect.", likes: 470, comments: 36 },
];
